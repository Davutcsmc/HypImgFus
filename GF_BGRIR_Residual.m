function [ I_HS_BGRIR ] = GF_BGRIR_Residual( I_HS,I_PAN, dataset )
...
% [agirlikMatrisiB] = agirliklarinHesaplanmasi2(I_PAN(:,:,1), I_HS_MaskBR);
% [agirlikMatrisiG] = agirliklarinHesaplanmasi2(I_PAN(:,:,2), I_HS_MaskGR);
% [agirlikMatrisiR] = agirliklarinHesaplanmasi2(I_PAN(:,:,3), I_HS_MaskRR);
% [agirlikMatrisiIR] = agirliklarinHesaplanmasi2(I_PAN(:,:,4), I_HS_MaskIRR);
