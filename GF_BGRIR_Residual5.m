function [ I_HS_BGRIR ] = GF_BGRIR_Residual5( I_HS,I_PAN, dataset, distPower )
...
[refBandB_EdgePreserveInterpolation] = edgePreserveInterpolation4(I_PAN(:,:,1),refBandB,distPower);
[refBandG_EdgePreserveInterpolation] = edgePreserveInterpolation4(I_PAN(:,:,2),refBandG,distPower);
[refBandR_EdgePreserveInterpolation] = edgePreserveInterpolation4(I_PAN(:,:,3),refBandR,distPower);
[refBandIR_EdgePreserveInterpolation] = edgePreserveInterpolation4(I_PAN(:,:,4),refBandIR,distPower);
...
for i=1:1:size(sRatioB,3)
    ...
    bandR = sRatioR(:,:,i);
    bandIR= sRatioIR(:,:,i);
    [sRatioB_EdgePreserveInterpolation(:,:,i)] = edgePreserveInterpolation4(I_PAN(:,:,1),bandB,distPower);
    [sRatioG_EdgePreserveInterpolation(:,:,i)] = edgePreserveInterpolation4(I_PAN(:,:,2),bandG,distPower);
    [sRatioR_EdgePreserveInterpolation(:,:,i)] = edgePreserveInterpolation4(I_PAN(:,:,3),bandR,distPower);
    [sRatioIR_EdgePreserveInterpolation(:,:,i)] = edgePreserveInterpolation4(I_PAN(:,:,4),bandIR,distPower);
