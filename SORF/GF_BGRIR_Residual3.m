...
[agirlikMatrisiB] = edgePreserveInterpolationAlg3(I_PAN(:,:,1), I_HS_MaskBR,distPower);
[agirlikMatrisiG] = edgePreserveInterpolationAlg3(I_PAN(:,:,2), I_HS_MaskGR,distPower);
[agirlikMatrisiR] = edgePreserveInterpolationAlg3(I_PAN(:,:,3), I_HS_MaskRR,distPower);
[agirlikMatrisiIR] = edgePreserveInterpolationAlg3(I_PAN(:,:,4), I_HS_MaskIRR,distPower);
